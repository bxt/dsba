<script lang="ts">
	...
	import { isOnboardingCompleted, setOnboardingCompleted } from './persistence.svelte';
...
{#if !isOnboardingCompleted() || isManuallyOpened}
	<aside transition:slide class="flex flex-col gap-1">
		<p>
			DSBA (meaning Damn Simple Budget App) makes keeping track of your expenses simple: It's just a
			digital version of a wallet. You just enter how much you put in and out and it keeps track of
			the balance.
		</p>
		...
		<p>
			...
			<a href="https://github.com/bxt/dsba/issues" target="_blank" rel="noopener noreferrer"
